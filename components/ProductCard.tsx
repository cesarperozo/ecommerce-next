  ...
  return (
    <div className="bg-white rounded shadow-2xl">
      <div className="relative overflow-hidden max-h-60 reunded-t">
        ...
        <span className="absolute items-center justify-center px-2 py-1 mr-2 text-xs font-bold leading-none text-red-100 bg-red-600 rounded-full top-3 left-3">
          NEW
        </span>
      </div>
      <div className="p-4">
        <h2 className="max-w-xs text-lg text-gray-700 truncate title">
          {product.name}
        </h2>
      </div>
