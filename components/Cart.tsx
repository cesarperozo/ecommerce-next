...
const Cart = () => {
  ...
  const total = products
    .reduce((previousValue, product: Product) => {
          ...
          {products.length ? (
            <>
              <table className="w-full table-fixed Border-b">
                <thead className="divide-gray-300">
                  <tr className="uppercase ">
                    ...
                    <th className="w-1/2 text-sm text-left sm:text-base ">
                      Producto
                    </th>
                    <th className="text-sm text-left sm:text-base">Cantidad</th>
                    <th className="invisible text-sm text-left sm:text-base sm:visible">
                      Precio
                    </th>
                  ...
                  {products.map((product) => (
                    <tr key={product.id}>
                      ...
                      <td className="text-sm text-left sm:border-b sm:text-base">
                        <p className="w-3/4 sm:truncate " title={product.name}>
                          {product.name}
                        </p>
                      </td>
                      ...
                      <td className="text-sm text-left sm:border-b sm:text-base">
                        <button
                          ...
                          className="inline-flex items-center my-1 font-bold text-red-500 rounded"
                        >
              ...
              <div className="flex justify-end">
                <div className="flex justify-around w-full lg:w-1/3">
                  <p className="pt-5 pr-12 font-bold text-right uppercase sm:text-base">
                    Precio total
                  </p>
                  <p className="relative px-8 pt-6 pr-16 text-base uppercase">
                    $ {total}
                  </p>
                </div>
              </div>
            ...
            <div className="text-center text-gray-600">
              ...
              <p>
                ir a la lista de{' '}
                <Link href="/">
                  <a className="font-bold text-blue-500 underline">PRODUCTOS</a>
                </Link>
              </p>
            </div>
          )}
        ...
        {products.length !== 0 && (
          <div className="flex flex-col justify-end mt-4 sm:flex-row">
            <button
              ...
              onClick={() => handleEmpty()}
              className="inline-flex items-center justify-center px-12 py-2 font-bold text-white bg-red-500 rounded sm:ml-7 hover:bg-red-700"
            >
            ...
            <button
              ...
              className="inline-flex items-center justify-center px-12 py-2 mt-5 font-bold text-white bg-blue-500 rounded sm:m-0 sm:ml-7 hover:bg-blue-700 sm:m0"
            >
